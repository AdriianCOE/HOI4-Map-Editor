...
For release version `0.1.0-preview.5`, the outputs are:

```text
dist/HOI4-Map-Editor-v0.1.0-preview.5-linux-x86_64.tar.gz
dist/HOI4-Map-Editor-v0.1.0-preview.5-linux-x86_64.tar.gz.sha256
```

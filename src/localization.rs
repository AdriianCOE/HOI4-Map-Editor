...
pub fn ui_literal(english: &'static str) -> &'static str {
    let key = match english {
        ...
        "Review Project Changes" => "workspace.review_project_changes",
        "Save Project" => "workspace.save_project",
        ...
        "Export Map Image..." => "file.export_image",
        "Export Map Image 2x..." => "file.export_image_2x",
        "Export Map Image 4x..." => "file.export_image_4x",
        "Undo" => "edit.undo",
        "Redo" => "edit.redo",
        ...
        "Edit Strategic Regions" => "strategic_regions.edit",
        "Strategic Region Tool: Select" => "strategic_regions.tool_select",
        "Strategic Region Tool: Brush" => "strategic_regions.tool_brush",
        "Strategic Region Tool: Fill" => "strategic_regions.tool_fill",
        "Strategic Region Tool: Lasso" => "strategic_regions.tool_lasso",
        ...
        "Validate Project" => "workspace.validate_project",
        ...
        "State Category" => "view.state_category",
        "Manpower" => "view.manpower",
        "Victory Points" => "view.victory_points",
        "Demilitarized Zones" => "view.dmz",
        "Rivers" => "view.rivers",

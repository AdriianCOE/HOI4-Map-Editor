...
mod tests {
    ...
    fn state_colors_are_deterministic_and_not_error_colors() {
        ...
        let distinct = (1..=1000).map(state_color).collect::<BTreeSet<_>>();
    ...
    fn selected_state_id_ignores_non_state_selections() {
        ...
        assert_eq!(
            selected_state_id(Some(&StateSelection::UnassignedProvince {
                province_id: 70
            })),
            None
        );
